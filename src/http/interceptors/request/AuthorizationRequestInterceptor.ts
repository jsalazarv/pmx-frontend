...
import {IRequestInterceptor} from "@/http/interceptors/types";
//import store from '../../../store';

const AuthorizationRequestInterceptor: IRequestInterceptor = async (config: AxiosRequestConfig) => {
    ...
    console.log("AUTHORIZATION REQUEST INTERCEPTOR: ", config);
